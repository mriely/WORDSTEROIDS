...
function broadcastSnapshot() {
  ...
  const snap = {
    ships,
    bullets: bullets.map(b => ({ x: Math.round(b.x), y: Math.round(b.y), vx: Math.round(b.vx || 0), vy: Math.round(b.vy || 0), c: b.color, k: b.isKing ? 1 : 0, fx: Math.round(b.fx || b.x), fy: Math.round(b.fy || b.y), nk: b.isNuke ? 1 : 0, nr: b.nukeRadius || 0, g: b.isGiant ? 1 : 0, gr: b.giantRadius || 0 })),
